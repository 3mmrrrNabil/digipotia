...
class _AuthRetrofitClient implements AuthRetrofitClient {
  _AuthRetrofitClient(
    ...
    baseUrl ??= 'http://ain.runasp.net/api/';
  }
  ...
  Future<LoginDto?> login(
    ...
    final _options = _setStreamType<LoginDto>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<String> verifyResetCode(VerifyResetCodeDtoRequest request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
